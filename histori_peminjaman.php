<?php 
    include "header.php";
?>
<h2>Histori Peminjaman Game dan Top up</h2>
<table class="table table-hover table-striped">
    <thead>
        <th>NO</th><th>Tanggal Pinjam</th><th>Tanggal harus Kembali</th><th>Nama Item</th><th>Status</th><th>Aksi</th>
    </thead>
    <tbody>
        <?php 
        include "koneksi.php";
        ...
        while($dt_histori=mysqli_fetch_array($qry_histori)){
            ...
            if(mysqli_num_rows($qry_cek_kembali)>0){
                ...
                $button_kembali="<a href='kembali.php?id=".$dt_histori['id_peminjaman_buku']."' class='btn btn-warning' onclick='return confirm(\"Apakah anda yakin?\")'>Kembalikan</a>";
            }
        ?>
            <tr>
